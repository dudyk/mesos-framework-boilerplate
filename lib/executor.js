...
function Executor (options) {
    ...
    if (envs.MESOS_FRAMEWORK_ID) {
        self.frameworkId = new mesos.FrameworkID(envs.MESOS_FRAMEWORK_ID);
    } else {
    ...
    if (envs.MESOS_EXECUTOR_ID) {
        self.executorId = new mesos.ExecutorID(envs.MESOS_EXECUTOR_ID);
    } else {
    ...
    if (envs.MESOS_DIRECTORY) {
        self.workingDirectory = envs.MESOS_DIRECTORY;
    } else {
    ...
    if (envs.MESOS_AGENT_ENDPOINT) {
        var endpointArray = envs.MESOS_AGENT_ENDPOINT.split(":");
